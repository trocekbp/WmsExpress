...
namespace Music_Store_Warehouse_App.Controllers
{
    public class DocumentsController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DocumentId,Number,Type,Date,OperationDate,TotalNetValue,TotalGrossValue,Description,ContractorId")] Document document)
        {
